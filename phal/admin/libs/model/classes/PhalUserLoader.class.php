...
class __PhalUserLoader extends __UserLoader {
    ...
    public function &loadUser(__IUserIdentity $user_identity) {
        ...
        if( $user_identity instanceof __AnonymousIdentity ) {
            ...
            if($login == __ApplicationContext::getInstance()->getPropertyContent('PHAL_ADMIN_LOGIN')) {
                $return_value = new __User();
                $credentials  = new __PasswordCredentials();
                $credentials->setPassword(__ApplicationContext::getInstance()->getPropertyContent('PHAL_ADMIN_PASSWORD'));
    ...
    public function &loadAnonymousUser() {
        ...
        if( __ContextManager::getInstance()->getContext('PHAL_ADMIN_AREA')->getPropertyContent('PHAL_ADMIN_AUTH_REQUIRED') == false) {
