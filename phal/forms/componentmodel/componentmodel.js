...
var __ClientEventHandler = Class.create({
    ...
    _addClientEndPointValuesToForm: function(form) {
        ...
        clientEndpointValues.setAttribute("value", Object.toJSON(this.getClientValues()));
    ...
    sendEvent: function(eventName, extraInfo, componentId, silentMode) {
        ...
        if(this.allowEvents) {
            ...
            new Ajax.Request(this.url, {
                ...
                evalJSON: false,
                method: 'post',
                parameters: {viewCode             : this.getViewCode(),
            				 _flowExecutionKey    : this.getFlowExecutionKey(),
                             clientEndpointValues : Object.toJSON(this.getClientValues()), 
                             event                : Object.toJSON($H({componentId : componentId, 
                                                        eventName   : eventName, 
                                                        extraInfo   : extraInfo}))},
...
var __FileUploader = Class.create({
    ...
    _addEventHandlers: function(inputelement) {
        inputelement.observe('change', function(event){
            var event = this.fire('phal:validate');
