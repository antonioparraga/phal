 ...
 *  - <b>route</b> and/or <b>controller</b> and/or <b>action</b> and/or a list of <b>parameters</b>, to build an url based on those values by ussing the phal url routing engine.<br>
 * <br>
 * i.e.
 * <code>
 * 
...
class __FormComponent extends __UIContainer  implements __ISubmitter {
     ...
     * Phal sets the last request in which this component was rendered in.
     ...
     * This method is used by Phal in order to determine where to redirect the flow in case
