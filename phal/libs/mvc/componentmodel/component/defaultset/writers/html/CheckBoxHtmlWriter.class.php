...
class __CheckBoxHtmlWriter extends __ComponentWriter {
    ...
    public function startRender(__IComponent &$component) {
        ...
        $return_value  = '<input type="checkbox"  ' . implode(' ', $properties) . '>';
        return $return_value;
    }
    ...
    public function renderContent($enclosed_content, __IComponent &$component) {
        ...
        $return_value = '<span id="' . $component->getId() . '_caption" ' . join(' ', $properties) . '>' . $component->getCaption() . '</span>';
        return $return_value;
    }
