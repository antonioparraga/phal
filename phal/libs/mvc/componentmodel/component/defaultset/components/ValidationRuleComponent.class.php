...
class __ValidationRuleComponent extends __UIComponent implements __IPoolable, __IValidator {
    ...
    protected $_error_message_if_not_valid = null;
	protected $_error_message_if_empty = null;

	const FORMAT_EMAIL = '^\s*(([A-Za-z0-9]+_+)|([A-Za-z0-9]+\-+)|([A-Za-z0-9]+\.+)|([A-Za-z0-9]+\++))*[A-Za-z0-9]+@((\w+\-+)|(\w+\.))*\w{1,63}\.[a-zA-Z]{2,6}\s*$';
	...
	public function setErrorMessageIfNotValid($error_message_if_not_valid) {
	    $this->_error_message_if_not_valid = $error_message_if_not_valid;
	}
	
	public function getErrorMessageIfNotValid() {
	    return $this->_error_message_if_not_valid;
	}

	public function setErrorMessageIfEmpty($error_message_if_empty) {
	    $this->_error_message_if_empty = $error_message_if_empty;
	}
	
    public function getErrorMessageIfEmpty() {
        return $this->_error_message_if_empty;    
    }	
